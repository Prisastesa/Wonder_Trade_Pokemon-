...
| nb_pokémon_échangés| nb_échanges| nb_total_pokémon|
|-------------------:|-----------:|----------------:|
|                 119|         200|              801|
...
|Statut    | Niveau.Moy| %Shiny| %Objet| %IV.Parfait| %Talent.Caché| %EggMoves|
|:---------|----------:|------:|------:|-----------:|-------------:|---------:|
