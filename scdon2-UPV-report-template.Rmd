...
Requête 6 : Relation entre la facilité de capture et le nombre d’échanges
...
REQUETE 7: Genre du dresseur et capacités du Pokémon
...
On observe d’abord une forte influence de la facilité de capture : les Pokémon communs sont nettement surreprésentés dans les échanges, ce qui traduit un flux principalement alimenté par des espèces abondantes. En revanche, les analyses par pays et par niveau ne révèlent pas de structure claire, suggérant que ces facteurs ont un impact limité, donc les différences des traineurs n'influencent pas le contenu des échanges.

Les tests d’hypothèses confirment partiellement ces observations. Une légère corrélation existe entre la rareté et la fréquence d’échange, mais elle reste faible. De même, l’anonymat des joueurs ne semble pas influencer les niveaux échangés.

En revanche, la satisfaction des joueurs est significativement liée à la présence de caractéristiques rares chez les Pokémon reçus. Le test du Khi² montre que les Pokémon possédant au moins un attribut spécial sont plus souvent appréciés, même si l’intensité de cette relation reste modérée.

Ainsi, les échanges apparaissent globalement structurés par des logiques simples liées à la rareté et à la valeur perçue des Pokémon, mais restent en grande partie influencés par des comportements diffus et peu prédictibles. Le système Wonder Trade combine donc une forte composante d’aléa avec quelques tendances comportementales identifiables.
