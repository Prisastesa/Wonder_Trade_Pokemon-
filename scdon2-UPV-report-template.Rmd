...
Cette étape permet d’identifier de manière unique chaque enregistrement de la table des échanges.
...
Cette requête permet d’évaluer le nombre de Pokémon échangés ainsi que la couverture du Pokédex.
